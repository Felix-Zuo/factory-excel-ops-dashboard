...
This project treats the repository as a reusable toolkit, not a one-off script.
The gates below define what must pass before a release or GitHub-facing update
is considered ready.
